...
SELECT name, language, percentage FROM country RIGHT JOIN countrylanguage ON country.code = countrylanguage.countrycode WHERE countrylanguage.language = 'Italian' ORDER BY percentage DESC LIMIT 1;
...
SELECT city.name FROM city RIGHT JOIN country ON city.id = country.capital WHERE country.capital = 211;
    name    
------------
 Bras�lia
(1 row)
...
--CHECK   SELECT * FROM city WHERE name = 'Bras�lia';
-- CHECK  SELECT * FROM city WHERE name = 'Brasilia';